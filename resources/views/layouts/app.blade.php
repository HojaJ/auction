...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen flex bg-blend-darken flex-col relative isolate" style='background-image:linear-gradient(0deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url("{{ asset('images/home.jpg') }}");     background-repeat: no-repeat;
    ...
    background-size: cover;'>
            ...
            <footer class="text-white shadow mt-auto" style="background-color: #0c8195">
                <div class=" max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
